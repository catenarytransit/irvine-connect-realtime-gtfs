...
use crate::matcher::{algorithm, VehicleStateManager};

const REALTIME_URL: &str = "https://passio3.com/irvine/passioTransit/gtfs/realtime/vehiclePositions";
...
pub async fn run_fetcher(
    ...
    println!("Starting realtime fetcher, polling every {}ms", FETCH_INTERVAL_MS);
